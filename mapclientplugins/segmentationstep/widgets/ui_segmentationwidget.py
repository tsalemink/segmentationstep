...
#
# Created: Mon May 26 21:27:55 2014
...
class Ui_SegmentationWidget(object):
    def setupUi(self, SegmentationWidget):
        ...
        self.file.setGeometry(QtCore.QRect(0, 0, 572, 630))
        ...
        self.gridLayout.addWidget(self.doneButton, 4, 0, 1, 1)
        spacerItem2 = QtGui.QSpacerItem(20, 40, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self.gridLayout.addItem(spacerItem2, 2, 0, 1, 1)
        self.verticalLayout_16.addWidget(self.groupBox_12)
        spacerItem3 = QtGui.QSpacerItem(17, 527, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self.verticalLayout_16.addItem(spacerItem3)
        self._toolBox.addItem(self.file, "")
        self.view = QtGui.QWidget()
        self.view.setGeometry(QtCore.QRect(0, 0, 558, 664))
        ...
        self.groupBox_9 = QtGui.QGroupBox(self.view)
        ...
        self._pushButtonViewAll = QtGui.QPushButton(self.groupBox_9)
        ...
        self._pushButtonReset = QtGui.QPushButton(self.groupBox_9)
        ...
        self.mode.setGeometry(QtCore.QRect(0, 0, 572, 630))
        ...
        self.image.setGeometry(QtCore.QRect(0, 0, 572, 630))
        ...
        self.points.setGeometry(QtCore.QRect(0, 0, 572, 630))
        self.points.setObjectName("points")
        self.verticalLayout_15 = QtGui.QVBoxLayout(self.points)
        self.verticalLayout_15.setObjectName("verticalLayout_15")
        self.groupBox_10 = QtGui.QGroupBox(self.points)
        ...
        self.doubleSpinBox = QtGui.QDoubleSpinBox(self.groupBox_10)
        ...
        self.groupBox_11 = QtGui.QGroupBox(self.points)
        ...
        self._toolBox.addItem(self.points, "")
        ...
        self._toolbarwidget3d = QtGui.QWidget(self.tab3d)
        self._toolbarwidget3d.setMinimumSize(QtCore.QSize(0, 15))
        self._toolbarwidget3d.setObjectName("_toolbarwidget3d")
        self.verticalLayoutTab3d.addWidget(self._toolbarwidget3d)
        ...
        self._toolbarwidget2d = QtGui.QWidget(self.tab2d)
        self._toolbarwidget2d.setMinimumSize(QtCore.QSize(0, 15))
        self._toolbarwidget2d.setObjectName("_toolbarwidget2d")
        self.verticalLayout_13.addWidget(self._toolbarwidget2d)
    ...
    def retranslateUi(self, SegmentationWidget):
        ...
        self.groupBox_3.setToolTip(QtGui.QApplication.translate("SegmentationWidget", "Set the view mode to projection or parallel", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.groupBox_6.setToolTip(QtGui.QApplication.translate("SegmentationWidget", "Set the icon sizes for the graphics", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.groupBox_2.setToolTip(QtGui.QApplication.translate("SegmentationWidget", "Set the mode for the 3D view", None, QtGui.QApplication.UnicodeUTF8))
        self.groupBox_2.setTitle(QtGui.QApplication.translate("SegmentationWidget", "View Mode 3D", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self._checkBoxStreamingCreate.setToolTip(QtGui.QApplication.translate("SegmentationWidget", "Add nodes in streaming mode ", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.groupBox_10.setTitle(QtGui.QApplication.translate("SegmentationWidget", "Push/Pull", None, QtGui.QApplication.UnicodeUTF8))
        self.label_10.setText(QtGui.QApplication.translate("SegmentationWidget", "Depth:", None, QtGui.QApplication.UnicodeUTF8))
        self.doubleSpinBox.setToolTip(QtGui.QApplication.translate("SegmentationWidget", "Set the depth for pushing/pulling segmentation points down/up a layer", None, QtGui.QApplication.UnicodeUTF8))
        self._pushButtonPushDown.setText(QtGui.QApplication.translate("SegmentationWidget", "Push Down", None, QtGui.QApplication.UnicodeUTF8))
        self._pushButtonPullUp.setText(QtGui.QApplication.translate("SegmentationWidget", "Pull Up", None, QtGui.QApplication.UnicodeUTF8))
        self.groupBox_11.setTitle(QtGui.QApplication.translate("SegmentationWidget", "Edit", None, QtGui.QApplication.UnicodeUTF8))
        self._pushButtonDelete.setToolTip(QtGui.QApplication.translate("SegmentationWidget", "Remove selected segmentation points", None, QtGui.QApplication.UnicodeUTF8))
        self._pushButtonDelete.setText(QtGui.QApplication.translate("SegmentationWidget", "Delete", None, QtGui.QApplication.UnicodeUTF8))
        self._toolBox.setItemText(self._toolBox.indexOf(self.points), QtGui.QApplication.translate("SegmentationWidget", "Points", None, QtGui.QApplication.UnicodeUTF8))
